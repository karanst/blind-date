...
// import 'package:blind_date/Model/referral_list_model.dart';
...
//                                     Text(referralList[index].type.toString(),
...
//                                     Text(DateFormat('dd MMM yyyy').format(DateTime.parse(referralList[index].dateCreated.toString())).toString(),
//                                         style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600,  color: Theme.of(context).colorScheme.fontColor) ),
//                                   ],
//                                 ),
//                               ],
...
//                                   Text(referralList[index].message.toString(),
//                                       style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600,  color: Theme.of(context).colorScheme.fontColor) ),
//                                 ],
//                               ),
//                             ),
