...
import 'package:blind_date/Screen/SignUp.dart';
  ...
  signInBtn() {
    return CupertinoButton(
      child: Container(
          ...
          child: Text(getTranslated(context, 'LOGIN_LBL')!.toUpperCase(),
  ...
  createAccBtn() {
    return CupertinoButton(
      child: Container(
          ...
          child: Text(getTranslated(context, 'CREATE_ACC_LBL')!.toUpperCase(),
              textAlign: TextAlign.center,
              style: Theme.of(context).textTheme.subtitle1!.copyWith(
